...
function Profile() {
  return (
    <div className="relative w-fit h-fit flex flex-col items-center">
      ...
      <h2 className="font-100 text-gray-7">Keep your eye on the prize</h2>
      <ul className='flex list-none p-0 space-x-5'>
        <li>
          <a href="https://twitter.com/JiuGuangjiu" className='text-gray-7 hover:text-green-4 duration-300'>
            <AiOutlineTwitter className='text-3xl' />
          </a>
        </li>
        <li>
          <a href='https://github.com/ma5hr00m' className='text-gray-7 hover:text-green-4 duration-300'>
